...
exports.MigrationContext = exports.V2TeamsfxFolder = void 0;
const tslib_1 = require("tslib");
const fs_extra_1 = tslib_1.__importDefault(require("fs-extra"));
const path_1 = tslib_1.__importDefault(require("path"));
const teamsfxFolder = "teamsfx";
const backupFolder = "backup";
exports.V2TeamsfxFolder = ".fx";
class MigrationContext {
    constructor(ctx) {
        ...
        this.backupPath = path_1.default.join(this.projectPath, teamsfxFolder, backupFolder);
    }
    ...
    async removeFxV2() {
        await this.fsRemove(exports.V2TeamsfxFolder);
    }
