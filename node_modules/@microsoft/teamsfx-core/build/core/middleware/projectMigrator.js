...
function getProjectMigratorMW() {
    if (tools_1.isMigrationV3Enabled()) {
        return projectMigratorV3_1.ProjectMigratorMWV3;
    }
    else {
        return exports.ProjectMigratorMW;
    }
}
exports.getProjectMigratorMW = getProjectMigratorMW;
...
function outputCancelMessage(ctx, isV3 = false) {
    ...
    if (inputs.platform === teamsfx_api_1.Platform.VSCode) {
        ...
        globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider.warning(`[core]If you are not ready to upgrade and want to continue to use the old version Teams Toolkit, please find Teams Toolkit in Extension and install the version ${versionDescription}`);
    }
    else {
        ...
        globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.logProvider.warning(`[core]If you are not ready to upgrade and want to continue to use the old version Teams Toolkit CLI, please install the version ${versionDescription}`);
    }
}
exports.outputCancelMessage = outputCancelMessage;
function getVersionDescription(isV3) {
    if (isV3) {
        return `"< ${versionMetadata_1.MetadataV3.vscodeStarterVersion}"`;
    }
    else {
        return `"<= 2.10.0"`;
    }
