...
async function loadProjectSettingsByProjectPath(projectPath, isMultiEnvEnabled = false) {
    try {
        if (tools_1.isV3Enabled()) {
            const settingsFile = path.resolve(projectPath, teamsfx_api_1.SettingsFolderName, teamsfx_api_1.SettingsFileName);
...
function getProjectSettingPathV3(projectPath) {
    return path.resolve(projectPath, teamsfx_api_1.SettingsFolderName, teamsfx_api_1.SettingsFileName);
}
