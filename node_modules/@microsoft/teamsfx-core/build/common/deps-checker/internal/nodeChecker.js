...
exports.ProjectNodeChecker = exports.AzureNodeChecker = exports.SPFxNodeChecker = exports.NodeChecker = void 0;
    ...
    async getInstallationInfo(installOptions) {
        ...
        try {
            ...
            if (!this.isVersionSupported(supportedVersions, currentVersion)) {
                const supportedVersionsString = this._type === depsChecker_1.DepsType.ProjectNode
                ...
                return NodeChecker.isVersionError(this._minErrorVersion, this._maxErrorVersion, currentVersion)
                    ? await this.getDepsInfo(false, supportedVersions, currentVersion.version, new depsError_1.NodeNotSupportedError(message_1.Messages.NodeNotSupported.split("@CurrentVersion")
                        .join(currentVersion.version)
                        .split("@SupportedVersions")
                        .join(supportedVersionsString), await this.getNodeNotSupportedHelpLink()))
                    : await this.getDepsInfo(true, supportedVersions, currentVersion.version, new depsError_1.NodeNotRecommendedError(message_1.Messages.NodeNotRecommended.split("@CurrentVersion")
                        .join(currentVersion.version)
                        .split("@SupportedVersions")
                        .join(supportedVersionsString), await this.getNodeNotSupportedHelpLink()));
            }
