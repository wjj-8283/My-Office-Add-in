...
import { DepsChecker, DependencyStatus } from "../depsChecker";
...
export declare class FuncToolChecker implements DepsChecker {
    ...
    checkPortableFuncVersion(): Promise<FuncInstallationStatus>;
    checkGlobalFuncVersion(): Promise<FuncInstallationStatus>;
