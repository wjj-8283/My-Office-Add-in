...
function isMigrationV3Enabled() {
    return featureFlags_1.isFeatureFlagEnabled(constants_1.FeatureFlagName.V3Migration, false);
}
...
async function getSideloadingStatus(token) {
    ...
    const instance = axios_1.default.create({
        baseURL: constants_5.getAppStudioEndpoint(),
        timeout: 30000,
    });
    ...
    do {
        ...
        try {
            ...
            telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, new teamsfx_api_1.SystemError({ error, source: "M365Account" }), {
                [telemetry_1.TelemetryProperty.CheckSideloadingStatusCode]: `${response === null || response === void 0 ? void 0 : response.status}`,
                [telemetry_1.TelemetryProperty.CheckSideloadingMethod]: "get",
                [telemetry_1.TelemetryProperty.CheckSideloadingUrl]: "<check-sideloading-status>",
            });
...
function getFixedCommonProjectSettings(rootPath) {
    ...
    try {
        if (isV3Enabled()) {
            const settingsPath = path.join(rootPath, teamsfx_api_1.SettingsFolderName, teamsfx_api_1.SettingsFileName);
            if (!settingsPath || !fs.pathExistsSync(settingsPath)) {
                return undefined;
            }
            const settings = fs.readJsonSync(settingsPath);
            return {
                projectId: (_a = settings === null || settings === void 0 ? void 0 : settings.trackingId) !== null && _a !== void 0 ? _a : undefined,
            };
        }
        else {
