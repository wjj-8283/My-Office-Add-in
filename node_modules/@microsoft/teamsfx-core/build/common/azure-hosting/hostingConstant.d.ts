...
export declare class AzureOpsConstant {
    static readonly TRY_LOGIN_AZURE: string;
    static readonly CHECK_OUTPUT_LOG_AND_TRY_TO_FIX: string;
    static readonly RETRY_CURRENT_STEP: string;
    static readonly FAIL_TO_GET_AZURE_CREDENTIALS: [string, string];
