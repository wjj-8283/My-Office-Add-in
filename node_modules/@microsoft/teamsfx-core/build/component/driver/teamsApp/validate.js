...
let ValidateTeamsAppDriver = class ValidateTeamsAppDriver {
    ...
    async validate(args, context, withEmptyCapabilities) {
        ...
        const manifestRes = await ManifestUtils_1.manifestUtils.getManifestV3(common_1.getAbsolutePath(args.manifestTemplatePath, context.projectPath), state, withEmptyCapabilities);
