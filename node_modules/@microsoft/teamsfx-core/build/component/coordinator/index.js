...
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            question: (context, inputs) => {
                return question_2.getQuestionsForInit("infra", inputs);
            },
            enableTelemetry: true,
...
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            question: (context, inputs) => {
                return question_2.getQuestionsForInit("debug", inputs);
            },
            enableTelemetry: true,
    ...
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            question: async (context, inputs) => {
                return await question_2.getQuestionsForProvisionV3(context, inputs);
            },
            enableTelemetry: true,
...
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            question: (context, inputs) => {
                return question_2.getQuestionsForPublishInDeveloperPortal(inputs);
            },
            enableTelemetry: true,
