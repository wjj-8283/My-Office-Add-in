...
async function updateManifest(ctx, inputs) {
    ...
    try {
        ...
        ctx.userInteraction
            .showMessage("info", localizeUtils_1.getLocalizedString("plugins.appstudio.teamsAppUpdatedNotice"), false, constants_3.Constants.VIEW_DEVELOPER_PORTAL)
            .then((res) => {
            if ((res === null || res === void 0 ? void 0 : res.isOk()) && res.value === constants_3.Constants.VIEW_DEVELOPER_PORTAL) {
                ctx.userInteraction.openUrl(util.format(constants_3.Constants.DEVELOPER_PORTAL_APP_PACKAGE_URL, result.value));
            }
        });
        return teamsfx_api_1.ok(teamsAppId);
    }
...
async function updateManifestV3(ctx, inputs) {
    ...
    try {
        ...
        (_e = ctx.logProvider) === null || _e === void 0 ? void 0 : _e.info(localizeUtils_1.getLocalizedString("plugins.appstudio.teamsAppUpdatedLog", teamsAppId));
        const url = util.format(constants_3.Constants.DEVELOPER_PORTAL_APP_PACKAGE_URL, result.value.get("TEAMS_APP_ID"));
