...
AppStudioError.AuthServiceAPIFailedError = {
    ...
    message: (e, requestPath, apiName) => [
        localizeUtils_1.getDefaultString("", e, requestPath, apiName),
        localizeUtils_1.getLocalizedString("", e, requestPath, apiName),
    ],
};
...
AppStudioError.IncorrectLocalDebugConfigError = {
    name: "IncorrectLocalDebugConfig",
    message: (error) => [
        localizeUtils_1.getDefaultString("error.appstudio.incorrectLocalConfig", error.message),
        localizeUtils_1.getLocalizedString("error.appstudio.incorrectLocalConfig", error.message),
    ],
};
...
AppStudioError.InvalidInputError = {
    name: "InvalidInput",
    message: (key, value) => [
        localizeUtils_1.getDefaultString("error.appstudio.invalidInput", key, value),
        localizeUtils_1.getLocalizedString("error.appstudio.invalidInput", key, value),
    ],
};
