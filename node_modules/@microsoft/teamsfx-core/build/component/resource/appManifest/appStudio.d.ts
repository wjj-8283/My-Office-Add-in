import { FxError, InputsWithProjectPath, M365TokenProvider, Result, ResourceContextV3, TeamsAppManifest, TokenProvider, v2, v3, ProjectSettingsV3, ProjectSettings, LogProvider } from "@microsoft/teamsfx-api";
...
export declare function checkIfAppInDifferentAcountSameTenant(teamsAppId: string, tokenProvider: M365TokenProvider, logger: LogProvider): Promise<Result<boolean, FxError>>;
/**
 * Update Teams app
 * @param ctx
 * @param inputs
...
export declare function updateManifestV3(ctx: ResourceContextV3, inputs: InputsWithProjectPath): Promise<Result<Map<string, string>, FxError>>;
export declare function updateManifestV3ForPublish(ctx: ResourceContextV3, inputs: InputsWithProjectPath): Promise<Result<any, FxError>>;
export declare function getAppPackage(teamsAppId: string, m365TokenProvider: M365TokenProvider, logProvider?: LogProvider): Promise<Result<AppPackage, FxError>>;
