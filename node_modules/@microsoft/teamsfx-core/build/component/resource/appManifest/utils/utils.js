...
const groupAppConfigured = (tab) => {
    const validGroupAppContext = lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.context, MeetingsContext.ChannelTab) ||
        lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.context, MeetingsContext.PrivateChatTab);
    const validGroupAppScope = lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.scopes, CommandScope.GroupChat) || lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.scopes, CommandScope.Team);
    return validGroupAppScope && validGroupAppContext;
};
const meetingExtensionConfigured = (tab) => {
    const validMeetingContext = lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.context, MeetingsContext.SidePanel) ||
        lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.context, MeetingsContext.DetailsTab) ||
        lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.context, MeetingsContext.ChatTab);
    const validMeetingScope = lodash_1.includes(tab === null || tab === void 0 ? void 0 : tab.scopes, CommandScope.GroupChat);
