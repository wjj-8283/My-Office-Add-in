...
exports.TabNonSsoAndDefaultBotItem = {
    id: "TabNonSsoAndBot",
    label: "", // No need to set display name as this option won't be shown in UI
};
exports.DefaultBotAndMessageExtensionItem = {
...
exports.TabFeatureIds = [
    exports.TabOptionItem.id,
    exports.TabNonSsoItem.id,
    exports.M365SsoLaunchPageOptionItem.id,
    exports.DashboardOptionItem.id,
];
