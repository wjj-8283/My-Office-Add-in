...
exports.getQuestionsForScaffolding = exports.getTemplate = exports.AddinProjectManifestQuestion = exports.AddinProjectFolderQuestion = exports.OfficeHostQuestion = exports.AddinLanguageQuestion = exports.AddinNameQuestion = exports.QuestionName = exports.OfficeAddinItem = exports.ImportAddinProjectItem = exports.OfficeAddinItems = void 0;
...
exports.AddinProjectManifestQuestion = {
    ...
    default: (inputs) => {
        const projFolder = inputs[exports.AddinProjectFolderQuestion.name];
        return path_1.default.join(projFolder, "manifest.json");
    },
};
...
const getQuestionsForScaffolding = () => {
    const nameNode = new teamsfx_api_1.QTreeNode(exports.AddinNameQuestion);
    ...
    importNode.condition = {
        validFunc: (input, inputs) => {
            ...
            if (cap === exports.ImportAddinProjectItem.id) {
                return undefined;
            }
