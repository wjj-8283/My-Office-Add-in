...
class OfficeAddinGenerator {
    static async generate(context, inputs, destinationPath) {
        ...
        const templateRes = await generator_1.Generator.generateTemplate(context, destinationPath, templateName, language === "TypeScript" ? "ts" : "js");
    ...
    static async doScaffolding(context, inputs, destinationPath) {
        ...
        const name = inputs[question_1.AddinNameQuestion.name];
